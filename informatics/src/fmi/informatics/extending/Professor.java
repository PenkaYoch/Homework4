...
public class Professor extends Person {
	...
	public Professor(String name, String title, int egn, int age, int height, int weight, char gender) {
		super(name, egn, gender, age, height, weight);
		this.title = title;
	}
	...
	public static class ProfessorGenerator {
		...
		public static Professor make() {
			...
			return new Professor(name, title, egn, age, height, weight, gender);
		}
	}
}
